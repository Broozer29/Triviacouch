...
public class HighscoreDaoImpl implements HighscoreDao {
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.HighscoreDao#createHighscore(java.sql.Connection, net.riezebos.triviacouch.domain.Deelnemer, net.riezebos.triviacouch.domain.SpelSessie)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.HighscoreDao#getHighScores(java.sql.Connection)
	 */
	@Override
