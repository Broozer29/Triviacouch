...
public class AntwoordDaoImpl implements AntwoordDao {
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#createAntwoord(java.sql.Connection, net.riezebos.triviacouch.domain.Antwoord, net.riezebos.triviacouch.domain.Vraag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#findAntwoordID(java.sql.Connection, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#findAntwoordenViaVraag(java.sql.Connection, net.riezebos.triviacouch.domain.Vraag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#updateAntwoord(java.sql.Connection, net.riezebos.triviacouch.domain.Antwoord)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#getAntwoordIDBijTekst(java.sql.Connection, net.riezebos.triviacouch.domain.Antwoord, net.riezebos.triviacouch.domain.Vraag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#deleteAntwoordenVanVraag(java.sql.Connection, net.riezebos.triviacouch.domain.Vraag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#deleteAntwoord(java.sql.Connection, net.riezebos.triviacouch.domain.Antwoord)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#getGegevenAntwoorden(java.sql.Connection, net.riezebos.triviacouch.domain.SpelSessie, net.riezebos.triviacouch.domain.Vraag)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see net.riezebos.triviacouch.persistence.AntwoordDao#matchAntwoord(java.sql.Connection, net.riezebos.triviacouch.domain.Vraag, java.lang.String)
	 */
	@Override
