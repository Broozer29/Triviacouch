...
alter table highscores add foreign key (spelerID) references speler(id)
alter table spelsessie add foreign key (vraagCode) references spelvraag(vraagID)
alter table spelvraag add foreign key (sessieID) references spelsessie(id)
alter table spelvraag add foreign key (vraagID) references vraag(id)
alter table antwoord add foreign key (vraagID) references vraag(id)
alter table deelnemer add foreign key (sessieID) references spelsessie(id)